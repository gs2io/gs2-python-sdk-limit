...
class DescribeCounterMasterRequest(Gs2BasicRequest):

    class Constant(Gs2Limit):
        FUNCTION = "DescribeCounterMaster"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeCounterMasterRequest, self).__init__(params)
        if params is None:
    ...
    def with_limit_name(self, limit_name):
        ...
        :type limit_name: unicode
        :return: this
        :rtype: DescribeCounterMasterRequest
        """
