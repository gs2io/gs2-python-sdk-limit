...
class CreateCounterMasterRequest(Gs2BasicRequest):

    class Constant(Gs2Limit):
        FUNCTION = "CreateCounterMaster"
    ...
    def __init__(self, params=None):
        ...
        """
        super(CreateCounterMasterRequest, self).__init__(params)
        if params is None:
    ...
    def with_limit_name(self, limit_name):
        ...
        :type limit_name: unicode
        :return: this
        :rtype: CreateCounterMasterRequest
        """
    ...
    def set_reset_type(self, reset_type):
        ...
        """
        if reset_type is not None and not (isinstance(reset_type, str) or isinstance(reset_type, unicode)):
    ...
    def set_reset_day_of_month(self, reset_day_of_month):
        ...
        """
        if reset_day_of_month is not None and not isinstance(reset_day_of_month, int):
    ...
    def set_reset_day_of_week(self, reset_day_of_week):
        ...
        """
        if reset_day_of_week is not None and not (isinstance(reset_day_of_week, str) or isinstance(reset_day_of_week, unicode)):
    ...
    def set_reset_hour(self, reset_hour):
        ...
        :type reset_hour: int
        """
        if reset_hour is not None and not isinstance(reset_hour, int):
