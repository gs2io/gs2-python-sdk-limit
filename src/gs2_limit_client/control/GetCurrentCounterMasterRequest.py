...
class GetCurrentCounterMasterRequest(Gs2BasicRequest):

    class Constant(Gs2Limit):
        FUNCTION = "GetCurrentCounterMaster"
    ...
    def __init__(self, params=None):
        ...
        """
        super(GetCurrentCounterMasterRequest, self).__init__(params)
        if params is None:
    ...
    def with_limit_name(self, limit_name):
        ...
        :type limit_name: unicode
        :return: this
        :rtype: GetCurrentCounterMasterRequest
        """
