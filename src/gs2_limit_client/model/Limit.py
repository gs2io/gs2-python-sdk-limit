...
class Limit(object):
    ...
    def __init__(self, params=None):
        if params is None:
            ...
            self.set_limit_id(params['limitId'] if 'limitId' in params.keys() else None)
    ...
    def get_limit_id(self):
        ...
        :rtype: unicode
        """
        return self.__limit_id

    def set_limit_id(self, limit_id):
        """
        回数制限GRNを設定
        :param limit_id: 回数制限GRN
        :type limit_id: unicode
        """
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(Limit, self).__getitem__(key)

    def to_dict(self):
        return {
            "limitId": self.__limit_id,
